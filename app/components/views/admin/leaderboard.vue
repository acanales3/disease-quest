    ...
    <div v-if="top3.length > 0" class="flex items-end justify-center gap-3 px-8">
      ...
      <div class="flex flex-col items-center flex-1 max-w-[220px]">
        <div class="mb-3 text-center">
          ...
          <p class="text-xs text-gray-500 truncate max-w-[180px]">{{ top3[1]?.nickname ?? '-' }}</p>
      ...
      <div class="flex flex-col items-center flex-1 max-w-[240px]">
        <div class="mb-3 text-center">
          ...
          <p class="text-xs text-gray-500 truncate max-w-[200px]">{{ top3[0]?.nickname ?? '-' }}</p>
      ...
      <div class="flex flex-col items-center flex-1 max-w-[220px]">
        <div class="mb-3 text-center">
          ...
          <p class="text-xs text-gray-500 truncate max-w-[180px]">{{ top3[2]?.nickname ?? '-' }}</p>
