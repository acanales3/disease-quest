  ...
  <div class="flex min-h-screen bg-[#f9fafb]">
    ...
    >
      ...
      >
        ...
        <NavBarsAdminNavBar class="flex-1 overflow-y-auto py-3 px-3" @click="sidebarOpen = false" />
      </aside>
    </Transition>

    <!-- Desktop sidebar -->
    <aside class="hidden lg:flex w-60 min-h-screen bg-white border-r border-gray-200/80 flex-col shrink-0">
      <div class="flex items-center gap-1 px-3 h-16 border-b border-gray-100 shrink-0">
